package com.codesroots.live_venodr.presentation.current_order_fragment
...
import com.codesroots.live_venodr.databinding.CurrentOrderFragmentBinding
import com.codesroots.live_venodr.helper.BaseApplication
import com.codesroots.live_venodr.helper.UserError
import com.codesroots.live_venodr.presentation.current_order_fragment.adapter.CurrentOrdersAdapter
...
class CurrentOrderFragment @Inject constructor() : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
     ...
     //   view.listener = ClickHandler()
        ...
        viewModel.intents.trySend(MainIntent.Initialize(viewModel.state.value!!,pref.userId))
        getAllData()
                    ...
                    if (it.error != null) {
                        ...
                        if (it.progress == true) {
                            ...
                            if (!it.data!!.results.isNullOrEmpty()) {
                                currentOrdersAdapter.submitList(it.data!!.results)
