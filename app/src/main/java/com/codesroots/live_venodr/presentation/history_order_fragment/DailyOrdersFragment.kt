package com.codesroots.live_venodr.presentation.history_order_fragment
...
import com.codesroots.live_venodr.databinding.DailyOrdersFragmentBinding
import com.codesroots.live_venodr.helper.UserError
import com.codesroots.live_venodr.models.current_orders.DateModel
import com.codesroots.live_venodr.presentation.history_order_fragment.adapter.HistoryOrdersAdapter
import com.codesroots.live_venodr.presentation.history_order_fragment.mvi.HistoryOrderViewmodel
import com.codesroots.live_venodr.presentation.history_order_fragment.mvi.MainIntent
                        ...
                        if (it.progress == true) {
                            ...
                            if (!it.data.isNullOrEmpty() ) {
                                ...
                                for (i in 0 until it.data!!.size) {
                                    ...
                                    orderPriceValue += it.data!![i].total!!
