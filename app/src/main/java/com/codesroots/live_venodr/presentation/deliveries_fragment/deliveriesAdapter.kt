package com.codesroots.live_venodr.presentation.deliveries_fragment
...
import com.codesroots.live_venodr.helper.Error_MotionToast
import com.codesroots.live_venodr.helper.FormValidationLogin
import com.codesroots.live_venodr.helper.SUCCESS_MotionToast
import com.codesroots.live_venodr.models.auth.AuthModel
import com.codesroots.live_venodr.models.auth.Driver
import com.codesroots.live_venodr.models.current_orders.SetorderToDelivery
...
//                if(itemClickable) {
                try {
                    frag.viewModel.OrderInfoLD!!.observe(frag.requireActivity(), Observer {model->
                        ...
                        dialog(model.delivery_serivce!!,p0)
    ...
    private fun dialog(delivery_service : Int,p0: CustomViewHolders, ){
        val user_id = frag.pref.userId
        ...
        pDialog.done.setOnClickListener {
            p0.sendNotificationToDevice(user_id,
                "طلب جديد",
