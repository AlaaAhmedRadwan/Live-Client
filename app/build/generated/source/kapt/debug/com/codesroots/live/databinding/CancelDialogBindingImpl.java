...
public class CancelDialogBindingImpl extends CancelDialogBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.call, 1);
        sViewsWithIds.put(R.id.commentText, 2);
        sViewsWithIds.put(R.id.send, 3);
        sViewsWithIds.put(R.id.sendMessage, 4);
        sViewsWithIds.put(R.id.cancelMessage, 5);
    ...
    public CancelDialogBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private CancelDialogBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
