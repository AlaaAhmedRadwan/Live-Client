...
public class HistoryOrderAdapterBindingImpl extends HistoryOrderAdapterBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.mView, 9);
        sViewsWithIds.put(R.id.iv_image, 10);
        sViewsWithIds.put(R.id.orderNumberText, 11);
    ...
    public HistoryOrderAdapterBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }
    private HistoryOrderAdapterBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.deliveryTimeText, deliveryTimeText.getResources().getString(R.string.deliveryTimeText));
        }
    }
