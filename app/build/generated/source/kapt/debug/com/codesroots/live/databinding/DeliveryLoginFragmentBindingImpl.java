...
public class DeliveryLoginFragmentBindingImpl extends DeliveryLoginFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.guid3, 3);
        sViewsWithIds.put(R.id.iv_logo, 4);
        sViewsWithIds.put(R.id.filledTextField, 5);
        sViewsWithIds.put(R.id.username, 6);
        sViewsWithIds.put(R.id.passwordfilledTextField, 7);
        sViewsWithIds.put(R.id.password, 8);
        sViewsWithIds.put(R.id.forgetPW, 9);
    ...
    public DeliveryLoginFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private DeliveryLoginFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
