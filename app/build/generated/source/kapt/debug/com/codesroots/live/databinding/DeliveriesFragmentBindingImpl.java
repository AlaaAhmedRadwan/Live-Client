...
public class DeliveriesFragmentBindingImpl extends DeliveriesFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.deliveriesRecycle, 3);
        ...
        sViewsWithIds.put(R.id.animation_view, 10);
    }
    // views
    @NonNull
    ...
    public DeliveriesFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private DeliveriesFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
